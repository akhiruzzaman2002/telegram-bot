...
# ---------------- CONFIG ----------------
BOT_TOKEN = os.getenv("TELEGRAM_TOKEN")  # Hosting এ .env বা Secret-এ TELEGRAM_TOKEN সেট করুন
if not BOT_TOKEN:
...
# (বাকী callback_handler, photo_handler, text_handler, inbox_command, otp_command আগের মতোই থাকবে)
